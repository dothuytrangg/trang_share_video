...
// import { Alert, Box, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, FormControl, Grid, InputLabel, MenuItem, Pagination, Paper, Select, SelectChangeEvent, Snackbar, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Tooltip, Typography } from "@mui/material";
...
//                                               >
//                                                   {tagDetail.map((tagDetail: any) => (
//                                                       <MenuItem key={tagDetail.id} value={tagDetail.tag_id}>  {/* Sử dụng tag_id làm value */}
//                                                           {tagDetail.name}  {/* Hiển thị tên tag */}
//                                                       </MenuItem>
//                                                   ))}
//                                               </Select>
//                                           </FormControl>
